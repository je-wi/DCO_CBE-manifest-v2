...
//console.log(d+': '+dlurl);
          ...
          browser.tabs.executeScript(newdata.tabId, { code: 'var dco_cbe_co = document.getElementById("dco_cbe_co"); if(dco_cbe_co) dco_cbe_co.innerHTML="<br>completed: '+dlname+'"+dco_cbe_co.innerHTML;' }, function() 
           ...
           window.setTimeout(startBulkDownload,interv,dltype);
...
function startBulkDownload(type)
 ...
 browser.tabs.executeScript(newdata.tabId, { code: 'var dco_cbe_co = document.getElementById("dco_cbe_co"); if(dco_cbe_co) dco_cbe_co.innerHTML="<br>completed: '+dlname+'"+dco_cbe_co.innerHTML;' }, function() 
        ...
        //recursively call of startBulkDownload here
        window.setTimeout(startBulkDownload,interv,dltype);               
    ...
    if( !something2down )
      ...
      browser.tabs.executeScript(newdata.tabId, { code: 'var dco_cbe_co = document.getElementById("dco_cbe_co"); if(dco_cbe_co) dco_cbe_co.innerHTML="'+completed + ' items downloaded<br />' + htmlcontent + '";' }, function() 
        {
        if (browser.runtime.lastError) 
          console.log('There was an error injecting script in startBulkDownload: \n' + browser.runtime.lastError.message);
        });
